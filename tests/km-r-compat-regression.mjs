...
// formar 46/46 quando a expressão é dividida pela mediana no modo R.
const n=92;
...
// NA é imputado pela mediana do gene antes do filtro, como no Script.R.
...
console.log('KM R-compatible regression: OK (92 -> 46/46)');
